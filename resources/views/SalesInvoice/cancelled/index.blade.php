                    ...
                    <tbody>
                        @foreach($sales_orders as $sales_order)
                            <tr>
                                ...
                                <td class="text-center"><a href="{{ url('sales-invoice/cancelled/' . $sales_order->uuid ) }}" class="{{ Helper::BP(5,3) }}" target="_self">{{ $sales_order->so_no }}</a></td>
