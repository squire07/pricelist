...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Sales Invoice - For Invoice</h1>
            </div>
        </div>
    </div>
@stop
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body table-responsive" style="overflow:auto;width:100%;position:relative;">
                ...
                <form id="request_date" class="form-horizontal" action="{{ url('sales-invoice/for-invoice') }}" method="get">
                    @csrf
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group form-group-sm">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append" onclick="window.location.assign('{{ url('sales-invoice/for-invoice') }}')">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                ...
                                <td class="text-center"><a href="{{ url('sales-invoice/for-invoice/' . $sales_order->uuid ) }}" class="{{ Helper::BP(2,3) }}" target="_self">{{ $sales_order->so_no }}</a></td>
