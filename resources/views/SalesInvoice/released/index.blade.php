                    ...
                    <tbody>
                        @foreach($sales_orders as $sales_order)
                            <tr>
                                ...
                                <td class="text-center"><a href="{{ url('sales-invoice/released/' . $sales_order->uuid ) }}" class="{{ Helper::BP(3,3) }}" target="_self">{{ $sales_order->so_no }}</a></td>
