...
@section('content')
    <div class="card">
        ...
        <div class="card-footer text-center">
            <a href="{{ url('sales-orders') }}" class="btn btn-lg btn-info"><i class="fas fa-arrow-left"></i>&nbsp;Back</a>
            <a href="{{ url('sales-orders/' . $sales_order->uuid . '/edit' ) }}" class="btn btn-lg btn-primary m-2"><i class="far fa-edit"></i>&nbsp;Edit</a>
            <button class="btn btn-lg btn-primary" id="btn-for-invoice" data-uuid="{{ $sales_order->uuid }}" data-so-no="{{ $sales_order->so_no }}"><i class="far fa-share-square"></i>&nbsp;For Invoicing</button>
        </div>
    </div>
