...
<div class="container-fluid">
    <!-- Tab Content -->
    <form class="tab-content" action="{{ route('delivery-management.update', $deliveries->uuid) }}" method="POST" id="form_delivery" autocomplete="off" enctype="multipart/form-data">
        <div class="card mb-4">
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <span class="input-group-text text-bold">Delivery Number&nbsp;<span></span></span>
                            </div>
                            <input type="text" class="form-control form-control-sm" id="delivery_status" value="{{ $deliveries->dr_no }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control form-control-sm" id="delivery_status" value="{{ $deliveries->delivery_status }}" name="delivery_status" readonly>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="input-group input-group-sm">
                ...
                <div class="row">
                        ...
                        <div>
                            ...
                            <select class="form-control form-control-sm select2 select2-primary" id="add_customers" name="store_name" data-dropdown-css-class="select2-primary" style="width: 100%;" required>
                                ...
                                @foreach($customers as $customer)
                                    ...
                                    {{ $deliveries->store_name == $customer->name ? 'selected' : '' }}
                    ...
                    <div class="col-md-2">
                        <div>
                            ...
                            <input type="text" class="form-control form-control-sm" name="srp_type" value="{{ $deliveries->srp_type }}" maxlength="25" id="add_srp_type" readonly>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div>
                            <label for="religion">Customer Category</label>
                            <input type="text" class="form-control form-control-sm" name="customer_category" value="{{ $deliveries->customer_category }}" maxlength="25" id="add_category" readonly>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div>
                            <label for="nationality">Area Group</label>
                            <input type="text" class="form-control form-control-sm" name="area_group" value="{{ $deliveries->area_group }}" maxlength="25" id="add_area_group" readonly>
                        </div>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="new_delivery_date" data-target-input="nearest">
                                <input type="text" name="delivery_date" id="delivery_date" class="form-control form-control-sm datetimepicker-input" data-target="#new_delivery_date" value="{{ $deliveries->delivery_date }}" required/>
                    ...
                    <div class="col-md-2">
                        <div>
                            ...
                            <select class="form-control form-control-sm" name="payment_terms" id="add_payment_terms">
                                <option value="" disabled>-- Select --</option>
                                @foreach($payment_terms as $payment_term)
                                    <option value="{{ $payment_term->name }}"
                                    {{ $deliveries->payment_terms == $payment_term->name ? 'selected' : '' }}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="new_due_date" data-target-input="nearest">
                                <input type="text" name="due_date" id="due_date" class="form-control form-control-sm datetimepicker-input" data-target="#new_due_date" value="{{ $deliveries->due_date }}" required/>
                    ...
                    <div class="col-md-2">
                        <div>
                            ...
                            <select class="form-control form-control-sm" name="delivered_by" id="add_drivers">
                                <option value="" disabled>-- Select Driver --</option>
                                @foreach($employees as $employee)
                                    @if($employee->role_id == 4)
                                        <option value="{{ $employee->name }}"{{ $deliveries->delivered_by == $employee->full_name ? 'selected' : '' }}>{{ $employee->full_name }}</option>
                                    @endif
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div>
                            ...
                            <select class="form-control form-control-sm" name="agents" id="add_agents">
                                <option value="" disabled>-- Select Agent --</option>
                                @foreach($employees as $employee)
                                    @if($employee->role_id == 5)
                                        <option value="{{ $employee->name }}"{{ $deliveries->agents == $employee->full_name ? 'selected' : '' }}>{{ $employee->full_name }}</option>
                                    @endif
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div>
                            ...
                            <input type="text" class="form-control form-control-sm" name="remarks" value="{{ $deliveries->remarks }}" id="remarks">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-4">
            ...
            <h5>Order Details</h5>
                ...
                <input type="hidden" name="add_discount" id="add_discount_percent">
                <input type="hidden" name="add_discount_value" id="hidden_add_discount_value">
                <input type="hidden" name="remarks" id="hidden_remarks">
                <input type="hidden" name="deleted_item_id" id="deleted_item_id">
                <input type="hidden" name="item_count" id="hidden_item_count" value="{{ count($deliveries->delivery_details) }}">
                <input type="hidden" name="hidden_current_grandtotal_amount" id="hidden_current_grandtotal_amount" value="0"/>
                <input type="hidden" name="version" value="{{ $deliveries->version }}">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <select class="form-control form-control-sm select2 select2-primary" id="item_name" data-dropdown-css-class="select2-primary " style="width:100%;" required>
                        ...
                        <table class="table table-bordered table-hover" id="table_item_details">
                            ...
                            @foreach($deliveries->delivery_details as $dd)
                                <tr>
                                    ...
                                    <td class="text-right">{{ number_format($dd->item_price, 2) }}</td>
                                    <td class="text-right">{{ number_format($dd->amount, 2) }}</td>
                                    <td class="text-center">
                                        <a href="#" class="btn-delete-item" type="button" data-id="{{ $dd->id }}" data-quantity="{{ $dd->quantity }}" data-amount="{{ $dd->amount }}" data-nuc="{{ $dd->nuc }}"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-right text-bold text-center"><span id="total_quantity_count">{{ $deliveries->total_quantity }}</span></td>
                                    <td class="text-right text-bold">Sub Total</td>
                                    <td class="text-right text-bold">
                                        <input type="text" class="text-right custom-input-text" name="total_amount" id="tfoot_subtotal_amount" value="{{ number_format($deliveries->total_amount, 2) }}" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-right text-bold">
                                        <input type="text" class="text-right custom-input-text" id="tfoot_add_discount_total_amount" value="{{ number_format($deliveries->add_discount_value, 2) }}" readonly/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right text-bold" colspan="5">Grand Total</td>
                                    <td class="text-right text-bold">
                                        <input type="text" class="text-right custom-input-text text-bold" name="grandtotal_amount" id="tfoot_grand_total_amount" value="{{ number_format($deliveries->grandtotal_amount, 2) }}" readonly>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                ...
                <div class="col-12">
                        <div class="form-group clearfix">
                            <div class="icheck-primary d-inline">
                                <input type="checkbox" id="checkbox_add_discount">
                                <label for="checkbox_add_discount">Add Discount:</label>
                                <span class="ml-2" id="span_discount_percent">{{ $deliveries->add_discount }} %</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <button class="btn btn-primary btn-lg m-2 " id="btn_save_so" {{ Helper::BP(1,2) }}><i class="fas fa-save mr-2"></i>Update Delivery</button>
            </div>
        </div>
    </form>
</div>
...
<script>
    $(document).ready(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                       ...
                       $('#table_item_details > tbody').empty();
                            ...
                            $('#tfoot_add_discount_total_amount').val(reset_amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
                            ...
                            $('#hidden_total_quantity').val('');
                            $('#hidden_add_discount').val('');
        ...
        $('#item_name').on('change', function() {
            var selectedOption = $(this).find('option:selected');
            var item_id = selectedOption.data('id');
        ...
        $('#add_item').on('click', function() {
            ...
            // Retrieve quantity input and validate
            var quantityInput = $('#quantity').val().trim();

            var quantity = parseInt(quantityInput);

        // Check if the item is already in the table (duplicate item check)
            var isExists = false;
            $('#table_item_details tbody tr').each(function() {
                var existingName = $(this).find('td:first').text().trim(); // Get text content of first column (item name)
                if (existingName === item_selected.name) {
                    isExists = true;
            ...
            // $('#table_item_details tbody tr').each(function() {
            //     var duplicateCode = $(this).find('input[name="item_code[]"]').val();
            //     if (duplicateCode === item_selected.code) {
            //         isDuplicate = true;
            //         return false; // Exit each loop early if duplicate found
            //     }
            // });
            ...
            var discountPercentage = parseFloat(item_discount) || 0;

            var discountedAmount = item_selected.amount * (1 - discountPercentage / 100);
            ...
            var newRow = `<tr>
                ...
                <td class="text-center"><a href="#" class="btn-delete-item" data-quantity="${quantity}" data-amount="${discountedAmount * quantity}"><i class="far fa-trash-alt"></i></a></td>
            ...
            console.log('item_count_add', item_count);

            // Update total quantity count
            var currentTotalQuantity = parseInt($('#total_quantity_count').text().trim()) || 0;
            var newTotalQuantity = currentTotalQuantity + quantity;
            $('#total_quantity_count').text(newTotalQuantity);

            // Update subtotal amount
            var currentSubtotal = parseFloat($('#tfoot_subtotal_amount').val().replace(/,/g, ''));
            sub_total_amount = currentSubtotal + (discountedAmount * quantity);

            // Handle potential discount checkbox and add_discount value
            var addDiscountCheckbox = $('#checkbox_add_discount');
            var addDiscountAmount = 0;
            if (addDiscountCheckbox.is(':checked')) {
                // Retrieve existing add_discount value (consider validation)
                addDiscountAmount = parseFloat($('#tfoot_add_discount_total_amount').val().replace(/,/g, ''));
            }

            // Update grand total amount
            grand_total_amount = sub_total_amount - addDiscountAmount;

            $('#hidden_current_grandtotal_amount').val(grand_total_amount);

            // Update displayed amounts with proper formatting
            $('#tfoot_subtotal_amount').val(sub_total_amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
            $('#tfoot_add_discount_total_amount').val(addDiscountAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
        ...
        $(document).on('click', '.btn-delete-item', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var current_add_discount = parseFloat($('#hidden_add_discount_value').val().replace(/,/g, ''));

                    // Calculate the current total quantity count
                    var currentTotalQuantity = parseInt($('#total_quantity_count').text().trim()) || 0;

                    console.log('cur qty :', currentTotalQuantity);                    

                    // Ensure quantity to be subtracted does not exceed the current total quantity
                    var newTotalQuantity = Math.max(0, currentTotalQuantity - quantity);
                    $('#total_quantity_count').text(newTotalQuantity);

                    console.log('tot qty :', newTotalQuantity);   
                    ...
                    console.log('item_deleted: ', deleted_item_id);
        ...
        $('#btn_save_so').on('click', function(e) {
            ...
            if(item_count > 0) {
                Swal.fire({
                    title: 'Are you sure you want to update this delivery?',
                    icon: 'warning',
                    showCancelButton: true,
                    allowEnterKey: false,
                    allowOutsideClick: false,
        ...
        // Handle modal close or cancel event to uncheck the checkbox
        $('#modal-add-discount').on('hide.bs.modal', function() {
            $('#checkbox_add_discount').prop('checked', false); // Uncheck the checkbox
        });

        // uncheck add_discount on modal close event
        $('#btn-add-discount').on('click', function() {
            var discountPercentage = parseFloat($('#modal_add_discount_amount_percentage').val()); // Get discount percentage from modal input
            $('#modal-add-discount').modal('hide');

            // Calculate the discount amount from the current grand total
            var current_grand_total_amount = parseFloat($('#tfoot_grand_total_amount').val().replace(/,/g, ''));
            var discountAmount = (current_grand_total_amount * discountPercentage) / 100;

            // Calculate new grand total after applying discount
            var newGrandTotal = current_grand_total_amount - discountAmount;

            // Update the displayed grand total amount
            $('#tfoot_grand_total_amount').val(newGrandTotal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));

            // Update tfoot_add_discount_total_amount to display the applied percentage and deducted amount
            var formattedDiscountInfo = `${discountPercentage}% / ${discountAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
            $('#tfoot_add_discount_total_amount').val(formattedDiscountInfo);

            $('#hidden_add_discount_value').val(discountAmount);

            // Check the checkbox_add_discount to indicate that a discount is applied
        ...
        $('#btn-add-remarks').on('click', function() {
            // get the value
            let remarks = $('#modal_new_remarks').val();
            // add the signee name to label
            $('#span_remarks').text(remarks.toUpperCase());
            // add to form hidden field
            $('#hidden_remarks').val(remarks.toUpperCase());
            // close the modal
        ...
        $('#btn-new-add-discount').on('click', function() {
            ...
            // Remove existing values before processing new discount

            // Clear the displayed discount label
            $('#span_discount_percent').text('');

            // Clear the hidden field for discount percentage
            $('#add_discount_percent').val('');
