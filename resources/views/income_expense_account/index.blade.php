                ...
                <form class="form-horizontal" action="" method="POST" id="form_modal_edit" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <label for="income_account">Income Account</label>
                                <input type="text" class="form-control form-control-sm" name="income_account" id="modal_edit_income_account" minlength="15" placeholder="IMPORTANT: Must be exactly same from ERPNext" required>
                            </div>
                            <div class="col-12">
                                <label for="expense_account">Expense Account</label>
                                <input type="text" class="form-control form-control-sm" name="expense_account" id="modal_edit_expense_account" minlength="15" placeholder="IMPORTANT: Must be exactly same from ERPNext" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
