...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Purchase Orders Management - Under Development</h1>
            </div>
            <div class="col-sm-6 text-right">
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-add" {{ Helper::BP(1,1) }}>Create New Delivery</button>
            </div>
        </div>
    </div>
@stop
...
@php
    $show_button_state = Helper::BP(1,3);
    $edit_button_state = Helper::BP(1,4);
@endphp
                    ...
                    <tbody>
                        @foreach($deliveries as $delivery)
                            <tr>
                                ...
                                <td class="text-center">{{ $delivery->updated_by }}</td>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-default btn_show" 
                                        ...
                                        data-delivery-updated_by="{{ $delivery->updated_by }}"
                                        {{ $show_button_state }}>
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary btn_edit" 
                                        ...
                                        data-uuid="{{ $delivery->uuid }}" 
                                        data-delivery-name="{{ $delivery->name }}" 
                                        data-delivery-remarks="{{ $delivery->remarks }}"
                                        {{ $edit_button_state }}>
